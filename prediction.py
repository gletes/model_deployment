...
def main():
    ...
    balance = st.number_input("Balance",min_value=0.00, max_value=1000000000.00, value=0.01)
    ...
    salary = st.number_input("Estimated salary",min_value=0.00, max_value=1000000000.00, value=0.01)
